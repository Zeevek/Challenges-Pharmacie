...
## v3.4 — juillet 2026
- Base de QR codes des plateformes de récompenses (Mon Cadeau INELDEA, Santis Officine, Opeaz, Pierre Fabre, Pluxee) fournie avec l'application (dossier `qr/`).
- Répartition : un menu « Plateforme » par laboratoire ; le QR et le lien s'affichent dans le plan de versement (et à l'impression) pour que chacun sache où récupérer ses gains.
