...
### 🎁 QR codes des plateformes

Le dossier [`qr/`](qr/) contient les QR codes des plateformes de récompenses laboratoires : Mon Cadeau INELDEA (ISN, Olioseptil), Santis Officine, Opeaz, Pierre Fabre et Pluxee. Dans la page **Répartition**, associez une plateforme à chaque laboratoire (menu « 🎁 Plateforme ») : le QR et le lien s'affichent dans le plan de versement — à l'écran comme à l'impression — pour que chaque membre de l'équipe sache où récupérer ses gains.
